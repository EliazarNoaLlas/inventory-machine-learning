...
almacenados_range = st.sidebar.slider("Filtrar por Rango de Productos Almacenados", min_value=0, max_value=30,
                                      value=(0, 30))
filtered_data = df[
    (df["PRODUCTOS ALMACENADOS"] >= almacenados_range[0]) & (df["PRODUCTOS ALMACENADOS"] <= almacenados_range[1])]
